...
ActiveRecord::Schema.define(version: 2018_07_06_091834) do
  ...
  create_table "user_projecs", force: :cascade do |t|
    t.bigint "project_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id"], name: "index_user_projecs_on_project_id"
    t.index ["user_id"], name: "index_user_projecs_on_user_id"
  end
  ...
  add_foreign_key "user_projecs", "projects"
  add_foreign_key "user_projecs", "users"
